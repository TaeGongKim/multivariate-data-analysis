...
# predict function 의 type="response" : probability prediction
...
cm_full <- table(lr_target, lr_predicted) # confusion metrix
cm_full
...
## multinom 함수 내에서 normalization 기능 내장되어있음!!!
