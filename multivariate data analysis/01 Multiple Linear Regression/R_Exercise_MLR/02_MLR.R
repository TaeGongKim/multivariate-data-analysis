...
## one-hot encoding
## 다중 공산성 문제???? (ex. c = 1-a-b) 
##  => linear regression 모델에서 자동으로 제거됨
...
mlr_corolla
summary(mlr_corolla) 
# NA -> 다중공산성 문제로 제거된 feature
# Adj R-Square : 0.913 -> 굉장히 높은 값 (데이터가 선형성을 많이 띈다.)
plot(mlr_corolla)
# 1 plot
# 가정 4. homoskedasticity check
# x축 : price, y축 : Residual
# 2 plot
# 가정 1. QQ-plot 
# noise의 정규성 확인, -2 ~ 2 범위 체크
################################
###### 3, 4 plot 공부!!! #######
################################
