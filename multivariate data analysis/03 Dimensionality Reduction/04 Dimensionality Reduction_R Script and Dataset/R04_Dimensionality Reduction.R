...
# numeric target -> factor target X
# Ploan_target <- as.factor(Ploan$Personal.Loan)
# numeric target으로 -> 이후 algorithm에서 factor 형태 X
...
Perf_Table
# Backward 방법을 적용했지만, 이때의 변수를 제거하지 못한듯!
...
# glmnet base model : Elastic model
# -> Ridge 사용시 alpha = 0 옵션 사용
